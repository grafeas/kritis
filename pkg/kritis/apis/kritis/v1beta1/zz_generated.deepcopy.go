...
func (in *AdmissionWhitelistPatternSpec) DeepCopyInto(out *AdmissionWhitelistPatternSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdmissionWhitelistPatternSpec.
func (in *AdmissionWhitelistPatternSpec) DeepCopy() *AdmissionWhitelistPatternSpec {
	if in == nil {
		return nil
	}
	out := new(AdmissionWhitelistPatternSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GenericAttestationPolicySpec) DeepCopyInto(out *GenericAttestationPolicySpec) {
	*out = *in
	if in.AmissionWhitelistPatterns != nil {
		in, out := &in.AmissionWhitelistPatterns, &out.AmissionWhitelistPatterns
		*out = make([]AdmissionWhitelistPatternSpec, len(*in))
		copy(*out, *in)
	}
