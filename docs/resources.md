...
Note that the list of [Attestation Authorities](#attestationauthority-crd) must be non-empty. If the list is empty, an error will be throw for malformed policy, and no image will be admitted, including allowlisted images.
